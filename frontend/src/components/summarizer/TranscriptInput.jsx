...
export default function TranscriptInput({ onGenerate, loading }) {
  ...
  return (
    <form
      ...
      className="bg-white rounded-3xl border border-[#EEECF8] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 flex flex-col h-[560px]"
    >
      ...
      <textarea
        ...
        className="w-full flex-1 rounded-2xl border border-[#E5E7EB] p-4 resize-none outline-none focus:ring-2 focus:ring-[#4F3FF0] text-[15px] text-[#15131C] placeholder:text-[#B0AEB8] overflow-y-auto"
      />
